...
public class PagesResponse implements Serializable {
	...
	@JsonProperty("paging")
	private PagesPaging paging;
	@JsonIgnore
	private Map<String, Object> additionalProperties = new HashMap<String, Object>();
	private final static long serialVersionUID = 7428400836350232807L;
	...
	@JsonProperty("paging")
	public PagesPaging getPaging() {
		return paging;
	}

	@JsonProperty("paging")
	public void setPaging(PagesPaging paging) {
		this.paging = paging;
	}
